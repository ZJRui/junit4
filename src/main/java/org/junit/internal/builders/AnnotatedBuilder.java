...
public class AnnotatedBuilder extends RunnerBuilder {
    ...
    public Runner runnerForClass(Class<?> testClass) throws Exception {
         ...
         *
         *???@RunWith??????????????? ?????? ?????????????????Spring??? ????????
         * ?1?@RunWith??????????@RunWith??????Runner ???? ????TestContext, TestContext ????@Test??????????????????????spring???
         *
         * ?2????Test?? ???Junit???????Statement???Statement?evaluate??????????????????????????
         * ????????????
         *
         * ?3???????????? ?????listener?????? ????????????????????????TestContext ??Spring????????????????????????
         *
         * ?4?????? ??????????? ??TestContext???? ?merge????configuration?
         *
         */
